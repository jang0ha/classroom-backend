...
--> statement-breakpoint
ALTER TABLE "subjects" ADD CONSTRAINT "subjects_departments_id_departments_id_fk" FOREIGN KEY ("departments_id") REFERENCES "public"."departments"("id") ON DELETE restrict ON UPDATE no action;